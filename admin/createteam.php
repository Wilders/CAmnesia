...
if(isset($_POST['username']) && isset($_POST['image']) && isset($_POST['rank'])) {
    if(empty($_POST['username']) OR empty($_POST['image']) OR empty($_POST['rank'])) {
        $errors['emptyone'] = "Un des champs est vide";
    }
    if(empty($errors)){
        $req = $bdd->prepare("INSERT INTO team (username, image, rank) VALUES (?, ?, ?)");
        $req->execute([$_POST['username'], $_POST['image'], $_POST['rank']]);
        $_SESSION['flash']['success'] = 'La personne a bien été ajoutée à la page!';
    }
}
...
<?php } ?>
            ...
            <main>
                <div class="content">
                    <h2 class="content-heading">Ajouter quelqu'un sur la page d'équipe</h2>
                    <div class="row gutters-tiny">
                        <div class="col-md-12">
                            <form action="" method="post">
                                <div class="block block-rounded block-themed">
                                    <div class="block-header bg-gd-primary">
                                        <h3 class="block-title">Nouvelle entrée</h3>
                                    </div>
...
<?php endforeach; ?><?php endif; ?>
                                    <div class="block-content block-content-full">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-12" for="description">Lien vers l'image</label>
                                            <div class="col-12">
                                                <input type="text" class="form-control" id="image" name="image" placeholder="Lien vers l'image">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-12" for="description">Rang</label>
                                            <div class="col-12">
                                                <input type="text" class="form-control" id="rank" name="rank" placeholder="Rang">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-12">

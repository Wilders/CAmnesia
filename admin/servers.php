...
$server = $bdd->query('SELECT * FROM servers ORDER BY id DESC');
$vocal = $bdd->query('SELECT * FROM vocal ORDER BY id DESC');
                        ...
                        <div class="col-md-7">
                            <div class="block block-rounded block-bordered">
                                <div class="block-header block-header-default border-b">
                                    <h3 class="block-title">Serveurs de jeux</h3>
                                    <span class="float-right"><a href="createservers.php">Ajouter un serveur</a></span>
                                </div>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <div class="btn-group btn-group-sm" role="group" aria-label="btnGroupIcons1">
                                                        <a href="../servers.php" target="_blank" class="btn btn-secondary">
                                                            <i class="fa fa-book"></i>
                                                        </a>
                                                        <a href="delservers.php?id=<?= $data['id']; ?>" class="btn btn-danger">
...
<?php } ?>
                        ...
                        <div class="col-md-5">
                            <div class="block block-rounded block-bordered">
                                <div class="block-header block-header-default border-b">
                                    <h3 class="block-title">Serveurs vocaux</h3>
                                    <span class="float-right"><a href="createvocal.php">Ajouter un serveur</a></span>
                                </div>
                                <div class="block-content">
                                    <table class="table table-responsive table-borderless table-striped">
                                        <thead>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <div class="btn-group btn-group-sm" role="group" aria-label="btnGroupIcons1">
                                                        ...
                                                        <a href="delvocal.php?id=<?= $data['id']; ?>" class="btn btn-danger">
                                                            <i class="fa fa-trash"></i>
                                                        </a>
                                                    </div>
                                                </td>

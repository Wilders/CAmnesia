...
$team = $bdd->query('SELECT * FROM team ORDER BY id DESC');
                    ...
                    <div class="sidebar-content">
                        ...
                        <div class="content-side content-side-full">
                            <ul class="nav-main">
                                ...
                                <li>
                                    <a href="team.php" class="active"><i class="si si-user"></i><span class="sidebar-mini-hide">Equipe</span></a>
                                </li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="block block-rounded block-bordered">
                                <div class="block-header block-header-default border-b">
                                    <h3 class="block-title">Utilisateurs sur la page d'équipe</h3>
                                    <span class="float-right"><a href="createteam.php">Ajouter quelqu'un sur la page</a></span>
                                </div>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <div class="btn-group btn-group-sm" role="group" aria-label="btnGroupIcons1">
                                                        <a href="../team.php" target="_blank" class="btn btn-secondary">
                                                            <i class="fa fa-book"></i>
                                                        </a>
                                                        <a href="delteam.php?id=<?= $data['id']; ?>" class="btn btn-danger">

...
if(isset($_POST['plateform']) && isset($_POST['address'])) {
    if(empty($_POST['plateform']) OR empty($_POST['address'])) {
        $errors['emptyone'] = "Un des champs est vide";
    }
    if(empty($errors)){
        $req = $bdd->prepare("INSERT INTO vocal (plateform, address) VALUES (?, ?)");
        $req->execute([$_POST['plateform'], $_POST['address']]);
        $_SESSION['flash']['success'] = 'Serveur vocal ajouté!';
    }
}
                            ...
                            <form action="" method="post">
                                <div class="block block-rounded block-themed">
                                    <div class="block-header bg-gd-primary">
                                        <h3 class="block-title">Nouveau serveur vocal</h3>
                                    </div>
...
<?php endforeach; ?><?php endif; ?>
                                    <div class="block-content block-content-full">
                                        <div class="form-group row">
                                            <label class="col-12" for="img_type">Plateforme</label>
                                            <div class="col-12">
                                                <select class="js-select2 form-control" id="plateform" name="plateform" style="width: 100%;" data-placeholder="Plateforme">
                                                    <option></option>
                                        ...
                                        <div class="form-group row">
                                            <label class="col-12" for="description">Adresse</label>
                                            <div class="col-12">
                                                <input type="text" class="form-control" id="address" name="address" placeholder="IP avec port pour TeamSpeak ou lien d'invitation pour Discord.">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-12">
